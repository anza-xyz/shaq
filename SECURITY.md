...
1. [Reporting security problems](#reporting-security-problems-in-shaq)
2. [Security Bug Bounties](#security-bug-bounties)

## Reporting security problems in shaq

**DO NOT CREATE A GITHUB ISSUE** to report a security problem.

Instead please use this [Report a Vulnerability](https://github.com/anza-xyz/shaq/security/advisories/new) link. Provide a helpful title, detailed description of the vulnerability and an exploit proof-of-concept. Speculative submissions without proof-of-concept will be closed with no further consideration.
